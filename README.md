...
| :--- | :--- | :--- |
| **1. Baselines** | [MESUEngine](file:///c:/Users/Anon/Downloads/Northstar/mnc_project/mnc/memory.py) vs. SGD baseline | SGD collapses ($0.20 \to 1.40/5$ recall); MESU maintains $2.90/5$ recall. |
